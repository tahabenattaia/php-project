...
// Vérifie si la session 'id' n'est pas définie, sinon redirige vers la page d'authentification
...
<div id="page_wrapper">
  <div id="sidenav" class="sidenav">
    ...
    <a href="../client/landing_page.php" class="sidenav_link ">
    <svg xmlns="http://www.w3.org/2000/svg" width="1.5em" height="1.5em" viewBox="0 0 20 20"><path fill="white" d="M5 1a2 2 0 0 0-2 2v1c0 5 2 8 7 8V9l5 4l-5 4v-3c-3.18 0-5.51-.85-7-2.68V17a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2z"/></svg>
        <h3>&nbsp; La page web client</h3>
        <button disabled class="external_link">
          <i class='bx bx-link-external' ></i>
        </button> 
      </a>
